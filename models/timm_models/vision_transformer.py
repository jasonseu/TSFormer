...
from .util.helpers import build_model_with_cfg, named_apply, adapt_input_conv
from .util.layers import PatchEmbed, Mlp, DropPath, trunc_normal_, lecun_normal_
...
class VisionTransformer(nn.Module):
    ...
    def load_pretrained(self, checkpoint_path, prefix=''):
        print('backbone params are initialized by {}'.format(checkpoint_path))
